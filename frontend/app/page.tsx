...
// API Version - using v2.2 for production (best semantic quality)
...
export default function Home() {
  ...
  const analyze = async () => {
    ...
    try {
      const response = await fetch(`${apiBaseUrl}/compute-essence-v2-2`, {
        method: "POST",
        headers: { 
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-bold mb-2 flex items-center gap-3">
                ...
                Platonic Ideal
                <Badge variant="outline" className="ml-2 text-sm font-normal bg-green-50 dark:bg-green-950 border-green-200 dark:border-green-800 text-green-700 dark:text-green-300">
                  {API_VERSION}
                </Badge>
              </h1>
              <p className="text-slate-600 dark:text-slate-400">
                Compute semantic essence vectors from word groups using advanced mathematical improvements
              </p>
            </div>
            <a 
              ...
              className="text-sm text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-300 transition-colors flex items-center gap-2"
            >
